// Testando o suporte ao navegador
...
if (window.SpeechRecognition === null) {
	...
	document.querySelector("#stop i").addEventListener("click",function(){
		try {
            recognizer.stop();
			document.getElementById("status").getElementsByTagName("span")[0].className = "parando";
			document.getElementById("status").getElementsByTagName("span")[0].innerHTML = "parando";
